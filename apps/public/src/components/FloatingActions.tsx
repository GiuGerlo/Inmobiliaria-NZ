  ...
  return (
    <div className="fixed bottom-6 right-5 z-40 flex flex-col gap-3">
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            whileTap={{ scale: 0.94 }}
            className="grid place-items-center rounded-full bg-navy text-gold shadow-lift"
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.08 }}
        whileTap={{ scale: 0.94 }}
        className="grid h-13 w-13 place-items-center rounded-full bg-[#25d366] text-white shadow-lift"
        style={{ height: 52, width: 52 }}
      >
        <WhatsAppIcon />
      </motion.a>
      <motion.a
        ...
        whileHover={{ scale: 1.08 }}
        whileTap={{ scale: 0.94 }}
        className="grid place-items-center rounded-full bg-gradient-to-br from-[#f58529] via-[#dd2a7b] to-[#8134af] text-white shadow-lift"
        style={{ height: 52, width: 52 }}
      >
        <Instagram size={24} />
      </motion.a>
